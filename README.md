...
* Download the latest release, either as a zip file:
  [DtdAnalyzer-0.2.zip](https://raw.github.com/NCBITools/DtdAnalyzer/gh-pages/images/DtdAnalyzer-0.2.zip);
  or as a gzipped tar:
  [DtdAnalyzer-0.2.tar.gz](https://raw.github.com/NCBITools/DtdAnalyzer/gh-pages/images/DtdAnalyzer-0.2.tar.gz).
